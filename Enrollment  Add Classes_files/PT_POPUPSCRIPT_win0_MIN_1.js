...
this.focusElem = null; this.bFocus=true; this.bIs_shown = false; this.nOpenDelay = 1; this.nCloseDelay = 0.6; this.tHandle=null; this.nDefWidth = 250; this.nDefHeight = 200; this.nMinHeight = 40; this.nMinHeightMouseHvrPopUp = 100; this.nMinWidth = 60; this.MOcurrWidth = this.nDefWidth; this.MOcurrHeight = this.nDefHeight; this.MOPopContainer="win0MOpopupContainer"; this.MOPopupInner ="win0MOpopupInner"; this.MOPopFrame = "win0MOdivpopupFrame"; this.PSPAGECONTAINER ="win0divPSPAGECONTAINER"; this.FORMNAME="win0";this.x=0; this.y=0; this.hoverId=null; this.hoverpopupId=null; this.bNetscp=0; this.bFirefox=0; this.bSafari=0; this.bIE=0; this.bIE8=0; this.bIE9=0; this.bIE10=0; this.bChrome; this.fontW=7; this.fontW2=9; this.fontH=18; this.agt=navigator.userAgent.toLowerCase();if(this.agt.indexOf("chrome")!=-1)
 ...
 this.bNetscp=1;else if(this.agt.indexOf(" msie ")!=-1) 
 { 
...
hItem=document.getElementById(this.hoverId); var bInPagelet = this.IsInPagelet(hItem); var viewportWidth = ptCommonObj2.getViewportWidth()*0.9; if (viewportWidth > 400)
 viewportWidth = 400; var viewportHeight = ptCommonObj2.getViewportHeight()*0.9; var nMaxLines = viewportHeight/this.fontH; var nMaxChars;if (this.bIE9)
 nMaxChars = viewportWidth/(this.fontW - 2); else if (this.bIE)
 {
 if (bInPagelet)
 {
 if (this.bIE8)
 nMaxChars = viewportWidth/(this.fontW - 1); else
 nMaxChars = viewportWidth/(this.fontW - 2);  }
 else
 nMaxChars = viewportWidth/(this.fontW - 1);  }
else 
 nMaxChars = viewportWidth/(this.fontW -2); var sText;var cells = document.getElementsByTagName("html"); var lang = (cells[0].attributes["lang"]).value; var bEnglish = false; var sText;if (lang == "en" || lang == "en-gb") 
...
var nLines=sArray.length; if (nLines > 4)
 {
 if (this.bIE9 || this.bFirefox) 
 nLines--; }
 
nLines += (nWraplines + 1); var nMaxChars2 = viewportWidth/this.fontW; if (nCharPerLine > nMaxChars2) 
