...
function doModal(url,bPrompt, oParentWin, sCancelName, form, name, sResponseHTML) {
 ...
 options += 'bClose@1;sCancelName@' + sCancelName + ';'; var nWaitMSec = 1000; var bWriteReponse = false; if (!browserInfoObj2.isIE && typeof sResponseHTML != "undefined")
 ...
 nWaitMSec = 100; window.modWin.contentDocument.write(sResponseHTML); setModWinID = setModWinParentPIA(); }
 ...
 else if (window.modWin.contentWindow)
 {
 try {
