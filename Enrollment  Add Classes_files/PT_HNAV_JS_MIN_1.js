var listFormat = false;var ptBaseURI = getptBaseURI();var const_keyCode = { ARRLEFT : 37,ARRUP : 38,ARRRIGHT : 39,ARRDN : 40,ENTER : 13,
 ...
 if (key == 13 && ev.target.id == "pthnavsrchinput")
 ...
 var UnPathPos = String(UniNavTgt).indexOf("uninavpath="); var UnParam = ""; if(aCref.href && aCref.href.indexOf("cmd=uninav") == -1)
 UnParam = "&cmd=uninav"; var UniNavABNPCodeVal = ""; if (isUnAbn == "true" && (typeof liCref.attributes['uninavabnpcode']) != "undefined" ){
